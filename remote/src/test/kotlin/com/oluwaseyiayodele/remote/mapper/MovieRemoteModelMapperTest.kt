package com.oluwaseyiayodele.remote.mapper

import com.oluwaseyiayodele.remote.DummyData
...
class MovieRemoteModelMapperTest {
    ...
    fun `check that mapFromModel returns correct data`() {
        ...
        assertThat(movieRemoteModelMapper.IMAGE_BASE_URL.plus(movieRemotemodel.backdrop_path)).isEqualTo(
            movieEntity.backdropPath
        )
        assertThat(movieRemoteModelMapper.IMAGE_BASE_URL.plus(movieRemotemodel.poster_path)).isEqualTo(
